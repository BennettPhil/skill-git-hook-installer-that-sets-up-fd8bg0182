...
DEFAULT_TOPIC="A git hook installer that sets up pre-commit, pre-push, and commit-msg hooks for a project. Include configurable checks for linting, test running, commit message format, and branch naming conventions."
DEFAULT_CONTEXT=""
